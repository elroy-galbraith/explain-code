...
`genai-eval` qualifies a GenAI evaluation as a measurement instrument, before
its numbers get trusted. Its `eval-qualify` skill runs a stdlib-only CLI over a
...
│   └── tests/                      # 218 tests, one suite per module
